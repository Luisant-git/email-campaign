...
import DashboardFilters from "../dashboard/DashboradFilters";
...
const CampaignList = () => {
  ...
  useEffect(() => {
    ...
    const handleClick = (e) => {
      // Only close if click is outside the dropdown menu and toggle
      if (
        !document
          .querySelector(".custom-dropdown-toggle")
          ?.contains(e.target) &&
        !document.querySelector(".custom-dropdown-menu")?.contains(e.target)
      ) {
      ...
      <div className="dashboard-topbar d-flex align-items-center mb-3">
        <div className="dashboard-actions d-flex align-items-center ms-auto">
          ...
          >
            ...
            <Dropdown.Menu
              className={`custom-dropdown-menu${showFilters ? " show" : ""}`}
            >
              <DashboardFilters />
            </Dropdown.Menu>
          </Dropdown>
      ...
      <div className="campaign-table-container">
        <div className="campaign-table">
          <div className="campaign-table-header d-flex">
            <div className="campaign-col campaign-details">
              Campaign Details
            </div>
          ...
          {campaigns.map((c, idx) => (
            <div
              className="campaign-table-row d-flex align-items-center"
              key={idx}
            >
              <div className="campaign-col campaign-details d-flex align-items-center">
                ...
                <div className="campaign-info">
                  ...
                  <div className="campaign-meta">
                    Drafted | Created At: {c.created} | {c.sequences} sequence
                    {c.sequences > 1 ? "s" : ""}
                  </div>
                </div>
              </div>
              <div className="campaign-col report-col d-flex align-items-center">
                ...
                <div className="report-item">
                  <a href="#" className="go-inbox-link">
                    Go To Master Inbox
                  </a>
                </div>
                <div className="report-item">
